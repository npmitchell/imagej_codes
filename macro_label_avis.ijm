...
run("Label...", "format=00:00 starting=0 interval=1 x=5 y=20 font=36 text=[] range=1-1203 use");
run("Label...", "format=00:00 starting=0 interval=1 x=5 y=41 font=36 text=[(no blue light)] range=1-1 use");
